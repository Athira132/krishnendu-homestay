...
export const ATTRACTIONS: Attraction[] = [
  {
    ...
    distanceNotice: 'Distance will be updated after confirming the property location (Located in North Nada vicinity).',
    approxDriveTime: 'Approx. 2–5 min drive / short ride from North Nada',
  ...
  },
  {
    ...
    distanceNotice: 'Distance will be updated after confirming the property location.',
    approxDriveTime: 'Approx. 5–8 min road drive from North Nada',
  ...
  },
  {
    ...
    distanceNotice: 'Distance will be updated after confirming the property location.',
    approxDriveTime: 'Approx. 5–10 min road drive from North Nada',
  ...
  },
  {
    ...
    distanceNotice: 'Distance will be updated after confirming the property location.',
    approxDriveTime: 'Approx. 8–12 min road drive (approx. 3 km from town center)',
  ...
  },
  {
    ...
    distanceNotice: 'Distance will be updated after confirming the property location.',
    approxDriveTime: 'Approx. 12–15 min road drive (approx. 5 km from Guruvayur)',
  ...
  },
  {
    ...
    category: 'temple',
    image: '/images/attractions/kerala-backwaters.jpg',
    shortDescription:
    ...
    distanceNotice: 'Distance will be updated after confirming the property location.',
    approxDriveTime: 'Approx. 5–7 min road drive',
...
export const TRANSIT_HUBS: TransitHub[] = [
  {
    ...
    distanceNotice: 'Distance will be updated after confirming the property location.',
    approxTravelTime: 'Approx. 5–10 min road drive from North Nada',
    directionsUrl: 'https://maps.google.com/?q=Guruvayur+Railway+Station',
    tips: 'Direct trains available to and from major Kerala cities, Chennai, Bangalore, and Mumbai. Auto-rickshaws and taxis are readily available outside the station.',
  },
  {
    id: 'ksrtc',
    ...
    distanceNotice: 'Distance will be updated after confirming the property location.',
    approxTravelTime: 'Approx. 4–8 min road drive from North Nada',
    directionsUrl: 'https://maps.google.com/?q=KSRTC+Bus+Station+Guruvayur',
    tips: 'Regular Kerala State RTC Superfast and Fast Passenger services connect to Thrissur, Ernakulam, Kozhikode, Palakkad, and Bangalore.',
  },
  {
    id: 'private-bus',
    ...
    image: '/images/hero-guruvayur.png',
    distanceNotice: 'Distance will be updated after confirming the property location.',
    approxTravelTime: 'Approx. 5–8 min road drive from North Nada',
    directionsUrl: 'https://maps.google.com/?q=Private+Bus+Stand+Guruvayur',
    tips: 'Frequent local private buses commute every few minutes to Chavakkad, Kunnamkulam, Thrissur town, and coastal routes.',
  },
  {
    id: 'airport',
    name: 'Cochin International Airport (COK)',
    type: 'airport',
    image: '/images/attractions/transit-airport.jpg',
    distanceNotice: 'Approx. 80 km road distance from Guruvayur.',
    approxTravelTime: 'Approx. 2.0 to 2.5 hours by taxi / car',
    directionsUrl: 'https://maps.google.com/?q=Cochin+International+Airport',
    tips: 'Nearest major international airport with extensive domestic and Gulf/international flight connectivity. Pre-paid airport taxis provide door-to-door transit directly to Guruvayur.',
  },
];
